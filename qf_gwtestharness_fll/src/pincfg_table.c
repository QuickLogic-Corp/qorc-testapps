...
PadConfig pincfg_table[] = 
{
  ...
  { // Pad 41 -- USB D+
	...
	{ // Pad 2 -- DBG speedup interrupt (output)
    .ucPin = PAD_2,
	...
	{ // Pad 3 -- DBG bitclk master (output)
    .ucPin = PAD_3,
	...
	{ // Pad 8 -- DBG I2S bitclk slave (output)
    .ucPin = PAD_8,
	...
	{ // Pad 27 -- DBG slowdown interrupt (output)
    .ucPin = PAD_27,
    ...
    { // Pad 32 -- DBG master aheadt (output)
    .ucPin = PAD_32,
