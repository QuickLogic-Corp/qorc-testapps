...
const struct cli_cmd_entry qf_gwtest[] =
{
    ...
    CLI_CMD_SIMPLE( "baseaddr", setbaseaddr, "0xaddr -- base address for GW"),
    CLI_CMD_WITH_ARG( "rr0", readregx, 0x00, "read register at offset 0 from base addr"),
    CLI_CMD_WITH_ARG( "rr4", readregx, 0x04, "read register at offset 4 from base addr"),
    CLI_CMD_WITH_ARG( "rr8", readregx, 0x08, "read register at offset 8 from base addr"),
    CLI_CMD_WITH_ARG( "rrc", readregx, 0x0c, "read register at offset C from base addr"),
    ...
    CLI_CMD_WITH_ARG( "wr0", writeregx, 0x00, "value -- write value to register at offset 0 from base addr"),
    CLI_CMD_WITH_ARG( "wr4", writeregx, 0x04, "value -- write value to register at offset 4 from base addr"),
    CLI_CMD_WITH_ARG( "wr8", writeregx, 0x08, "value -- write value to register at offset 8 from base addr"),
    CLI_CMD_WITH_ARG( "wrc", writeregx, 0x0c, "value -- write value to register at offset C from base addr"),
